...
Focus on established businesses with verifiable contact information.`;
  ...
  // Serve terms and conditions documents - Download actual uploaded files
  app.get('/api/terms/download/:entityId', async (req, res) => {
    try {
      const { entityId } = req.params;
      console.log('DEBUG: Downloading terms for entity:', entityId);
      ...
      console.log('DEBUG: Terms path found:', termsPath);
...
Generated on: ${new Date().toLocaleString()}`;
      ...
      if (termsPath.startsWith('https://storage.googleapis.com/')) {
        console.log("DEBUG: Downloading from Google Cloud Storage URL");
        ...
        if (!exists) {
          console.log("DEBUG: File not found in storage");
      ...
      console.error("DEBUG: Error in terms download:", error);
