...
LOCAL_APPS = [
    'procurement.apps.users',
    'procurement.apps.vendors',
    'procurement.apps.products',
    'procurement.apps.boms',
    'procurement.apps.rfx',
    'procurement.apps.auctions',
...
MIDDLEWARE = [
    ...
    'procurement.apps.users.middleware.SessionAuthMiddleware',
...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://user:password@localhost:5432/procurement')
    )
}
