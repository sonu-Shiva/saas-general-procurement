    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('buyer_admin', 'Buyer Admin'), ('buyer_user', 'Buyer User'), ('sourcing_manager', 'Sourcing Manager'), ('vendor', 'Vendor')], default='buyer_user', max_length=20)),
